		...
		<Dialog open={isOpen} onOpenChange={setIsOpen}>
			<DialogContent className="sm:max-w-3xl p-0 overflow-hidden bg-white dark:bg-dark-900">
				<div className="flex flex-col sm:flex-row">
					...
					<div className="flex-grow flex-shrink-0 basis-[55%] justify-center flex flex-col items-stretch">
						<div className="p-8">
							<DialogHeader>
						...
						<div className="w-full bg-gray-100 dark:bg-gray-800 py-4 text-sm text-center text-gray-500 dark:text-gray-400">
