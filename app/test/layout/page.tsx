      ...
      <div className="flex flex-col flex-grow">
        <div className="flex-grow flex overflow-hidden">
          ...
          >
            ...
            <div className={`py-2 border-b border-gray-200 flex items-center justify-between px-4 ${sidebarOpen ? "" : "pl-20"}`}>
            ...
            {items.map((item) => (
              <div
                key={item.id}
                className="relative p-4 border-b border-gray-200 cursor-pointer"
